...
const Title = ({ title, subTitle }) => {
  return (
  <h1 className="font-titleFont font-semibold text-lg md:text-xl capitalize text-textColor relative z-10 px-3 sm:px-4 md:px-6 py-2 md:py-3 border-b border-b-zinc-800/70 group">
